...
from app.api.routes import amount_router, analysis_router, auth_router, chat_router, dashboard_router, decision_schedule_router, deliverable_router, document_router, invitation_router, project_router, search_router, task_router, task_suggestion_router, upload_router
...
app.include_router(task_suggestion_router.router)
