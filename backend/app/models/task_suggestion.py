...
class TaskSuggestion(Base):
    ...
    actor_scope: Mapped[str | None] = mapped_column(String(30))
    statement_type: Mapped[str] = mapped_column(
        String(40), nullable=False, default="OBLIGATION", server_default="OBLIGATION")
    task_kind: Mapped[str | None] = mapped_column(String(40))
