...
export default function WorkspacePage({ user, onLogout, notify }) {
  ...
  const { projects, loading } = useProjectsQuery(notify)
  ...
  return <WorkspaceContent project={project} tab={tab} navigate={navigate} notify={notify} user={user} onLogout={onLogout}/>
}

function WorkspaceContent({ project, tab, navigate, notify, user, onLogout }) {
